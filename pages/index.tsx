...
const CreatePreviewSection = () => {
  return (
    <div className="h-[calc(100vh-8rem)] flex flex-col justify-center xl:px-32 ">
      <div className="flex flex-row items-center space-x-10">
        <div className="basis-5/12 flex flex-col space-y-5">
          ...
          <div className="font-light text-xl">
            ...
            system, besides that you can also generate PDFs based on your custom
            content.{" "}
            <u>
              <b>
...
const BannerSection = () => {
  return (
    <div className="h-[calc(100vh-8rem)] flex flex-row items-center text-white bg-watanasa-spot-1 space-x-10 xl:px-32">
      <div className="basis-5/12 flex flex-col space-y-10">
        <div className="font-poppins font-semibold text-5xl leading-normal">
          Show off your personal branding and skills to the world
        </div>
        <div className="font-normal text-xl">
          We do our best to provide a platform for you to create and be creative
          to showcase your personal branding so that the world can see more of
          it
        </div>
